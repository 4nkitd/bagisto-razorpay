...
@keyframes spin {
 ...
 to {
  ...
  <body style="background: #edfffe; color: #000000" onload="document.forms['dagar_payment'].submit()">
    ...
    <div class=""  style=" color: #000000; position:fixed; height:100%; width:100%; top:40%; text-align: center; ">
      ...
      <form method="POST" action="https://api.razorpay.com/v1/checkout/embedded" name="dagar_payment" class="hidden" style="display: none">
